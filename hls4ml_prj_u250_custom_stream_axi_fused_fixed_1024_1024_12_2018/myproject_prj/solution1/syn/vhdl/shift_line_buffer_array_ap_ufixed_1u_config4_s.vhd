...
entity shift_line_buffer_array_ap_ufixed_1u_config4_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of shift_line_buffer_array_ap_ufixed_1u_config4_s is 
    ...
    component shift_line_buffer_array_ap_ufixed_1u_config4_s_line_buffebkb IS
    generic (
        DataWidth : INTEGER;
...
begin
    line_buffer_Array_V_1_0_0_U : component shift_line_buffer_array_ap_ufixed_1u_config4_s_line_buffebkb
    generic map (
        DataWidth => 16,
        AddressRange => 66,
        AddressWidth => 7)
    ...
    line_buffer_Array_V_1_1_0_U : component shift_line_buffer_array_ap_ufixed_1u_config4_s_line_buffebkb
    generic map (
        DataWidth => 16,
        AddressRange => 66,
        AddressWidth => 7)
