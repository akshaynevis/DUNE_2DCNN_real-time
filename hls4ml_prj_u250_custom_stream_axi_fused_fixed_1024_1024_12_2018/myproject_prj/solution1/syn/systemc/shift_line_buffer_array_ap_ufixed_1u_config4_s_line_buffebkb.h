...
#ifndef _shift_line_buffer_array_ap_ufixed_1u_config4_s_line_buffebkb_H_
#define _shift_line_buffer_array_ap_ufixed_1u_config4_s_line_buffebkb_H_
#include <systemc>
#include <iostream>
#include <fstream>
#include "AESL_pkg.h"
...
struct shift_line_buffer_array_ap_ufixed_1u_config4_s_line_buffebkb_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(shift_line_buffer_array_ap_ufixed_1u_config4_s_line_buffebkb_core);
    shift_line_buffer_array_ap_ufixed_1u_config4_s_line_buffebkb_core(sc_core::sc_module_name) {
        SC_METHOD(proc_dout);
...
SC_MODULE( shift_line_buffer_array_ap_ufixed_1u_config4_s_line_buffebkb )
{
    ...
    SC_CTOR( shift_line_buffer_array_ap_ufixed_1u_config4_s_line_buffebkb ) {
        meminst = new shift_line_buffer_array_ap_ufixed_1u_config4_s_line_buffebkb_core <DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    shift_line_buffer_array_ap_ufixed_1u_config4_s_line_buffebkb_core <DataWidth, AddressWidth, AddressRange>* meminst;

};

#endif //_shift_line_buffer_array_ap_ufixed_1u_config4_s_line_buffebkb_H_
