...
set ID 149
set hasByteEnable 0
set MemName shift_line_buffer_array_ap_fixed_8u_config7_s_line_bufferlbW
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_64_V_read { I 27 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_66_V_read { I 27 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_67_V_read { I 27 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_68_V_read { I 27 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_70_V_read { I 27 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_71_V_read { I 27 vector } } \
} "
}
