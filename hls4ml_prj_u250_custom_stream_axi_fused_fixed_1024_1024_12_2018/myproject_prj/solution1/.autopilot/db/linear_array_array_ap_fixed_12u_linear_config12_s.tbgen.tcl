set moduleName linear_array_array_ap_fixed_12u_linear_config12_s
set isTopModule 0
...
set C_modelName {linear<array,array<ap_fixed,12u>,linear_config12>}
