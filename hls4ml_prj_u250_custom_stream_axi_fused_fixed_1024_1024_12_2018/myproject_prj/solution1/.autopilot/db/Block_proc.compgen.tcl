...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_r_TDATA { O 1024 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { out_local_V_data_0_V_dout { I 1024 vector } out_local_V_data_0_V_empty_n { I 1 bit } out_local_V_data_0_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { out_local_V_data_1_V_dout { I 1024 vector } out_local_V_data_1_V_empty_n { I 1 bit } out_local_V_data_1_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 778 \
    name should_skip_0_loc \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_should_skip_0_loc \
    op interface \
    ports { should_skip_0_loc_dout { I 1 vector } should_skip_0_loc_empty_n { I 1 bit } should_skip_0_loc_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { val_assign_loc_dout { I 1 vector } val_assign_loc_empty_n { I 1 bit } val_assign_loc_read { O 1 bit } } \
} "
}
