...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_r_TDATA { I 1024 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_tmp_stream_V_V \
    op interface \
    ports { tmp_stream_V_V_din { O 16 vector } tmp_stream_V_V_full_n { I 1 bit } tmp_stream_V_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { val_assign_out_out_din { O 1 vector } val_assign_out_out_full_n { I 1 bit } val_assign_out_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 5 \
    name should_skip_0_out_out \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_should_skip_0_out_out \
    op interface \
    ports { should_skip_0_out_out_din { O 1 vector } should_skip_0_out_out_full_n { I 1 bit } should_skip_0_out_out_write { O 1 bit } } \
} "
}
